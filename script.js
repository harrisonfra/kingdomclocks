...
const ICONS = {
  ...
  // ── Custom icons ──────────────────────────────────────────────────────
  handshake: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="m11 17 2 2a1 1 0 1 0 3-3"/><path d="m14 14 2.5 2.5a1 1 0 1 0 3-3l-3.88-3.88a3 3 0 0 0-4.24 0l-.88.88a1 1 0 1 1-3-3l2.81-2.81a5.79 5.79 0 0 1 7.06-.87l.47.28a2 2 0 0 0 1.42.25L21 4"/><path d="m21 3 1 11h-1"/><path d="M3 3 2 14l6.5 6.5a1 1 0 1 0 3-3"/><path d="M3 4h8"/></svg>`,
  testTube: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M10 3 L 10 17 Q 10 20 12 20 Q 14 20 14 17 L 14 3"/><path d="M8 3 H 16"/><path d="M10 13 H 14"/></svg>`,
...
function makeDial(pct, inverted = false, isPlaceholder = false) {
  ...
  wrapper.innerHTML = `
    <svg class="dial-arc" viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg">
...
function openClockModal(data) {
  ...
  // Match the divider lines to the icon color
  document.querySelector('#clock-modal-card .modal-divider')
    .style.setProperty('--divider-color', color);
